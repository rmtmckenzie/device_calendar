...
class DeviceCalendarPlugin {
  ...
  Future<Result<String>> updateRecurrence(RecurrenceRule recurrenceRule) async {
    return _invokeChannelMethod(
      ChannelConstants.methodNameUpdateEvent,
      arguments: () => {'recurrenceRule': recurrenceRule.toJson()},
    );
  }
